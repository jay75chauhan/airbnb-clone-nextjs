    ...
    <div className="  flex h-screen items-center justify-center">
      ...
      <div className="bg-transparent   backdrop-blur-2xl z-20  shadow-2xl  rounded-3xl items-center justify-center p-12 sm:p-24  ">
        ...
        <div className="flex flex-col   mt-12">
          <button
            onClick={signIn}
            className=" py-3 backdrop-blur-3xl  text-xl  bg-transparent border-2 border-gray-300 shadow-inner  font-medium hover:text-gray-100 transition  transform duration-500 ease-in-out hover:scale-105 hover:shadow-2xl     rounded-full text-gray-300 text-center cursor-pointer"
          >
            Login with{" "}
          </button>
          <a
